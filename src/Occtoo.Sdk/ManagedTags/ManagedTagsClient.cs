...
public sealed class ManagedTagsClient
{
    ...
    public Task<Result<ManagedTag, OcctooError>> Get(
        ...
        CancellationToken cancellationToken = default) =>
        _api.Send(OcctooJsonApi.Request(HttpMethod.Get, TagUri(managedTagId)),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return _api
            .Send(
                OcctooJsonApi.Request(HttpMethod.Post, new Uri("v1/managed-tags", UriKind.Relative), body,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return _api
            .Send(
                OcctooJsonApi.Request(HttpMethod.Put, TagUri(managedTagId), body, ManagedTagsJsonContext.Default.UpdateManagedTagDto),
    ...
    public Task<UnitResult<OcctooError>> Delete(
        ManagedTagId managedTagId,
        CancellationToken cancellationToken = default) =>
        _api.Send(OcctooJsonApi.Request(HttpMethod.Delete, TagUri(managedTagId)), "delete managed tag", cancellationToken)
    ...
    public Task<Result<ManagedTagValue, OcctooError>> GetValue(
        ...
        CancellationToken cancellationToken = default) =>
        _api.Send(OcctooJsonApi.Request(HttpMethod.Get, ValueUri(managedTagId, key)),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return _api
            .Send(
                OcctooJsonApi.Request(HttpMethod.Post, new Uri($"v1/managed-tags/{managedTagId.Value:D}/values", UriKind.Relative),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return _api
            .Send(
                OcctooJsonApi.Request(HttpMethod.Put, ValueUri(managedTagId, key), body,
    ...
    public Task<UnitResult<OcctooError>> DeleteValue(
        ...
        ManagedTagValueKey key,
        CancellationToken cancellationToken = default) =>
        _api.Send(OcctooJsonApi.Request(HttpMethod.Delete, ValueUri(managedTagId, key)), "delete managed tag value", cancellationToken);
